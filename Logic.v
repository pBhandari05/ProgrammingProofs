...
(*Assume, for the sake of contradiction, that there exists a proposition P st P and ~P
are true. From the assumption that P is true, we conclude P. 
But from the assumption that ~ P is true, we conclude that P is false This is a 
contradiction.*)
