...
(* FILL IN HERE
Fixpoint bad_plus (n : nat) (m : nat) : nat :=
  if (n <=? m) then
    match n with
    | O => m
...
Proof.
  intros l H.
  destruct l; simpl in H; try discriminate; simpl; reflexivity.
Qed.
(** [] *)
...
(** **** Exercise: 2 stars, standard, optional (graded_lowered_once) *)
